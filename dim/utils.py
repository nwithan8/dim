...
def bool_to_string(boolean: bool, lowercase: bool = True) -> str:
    """
    ...
    :type lowercase: bool, default True
    :return: "True" or "False"
    :rtype: str
    """
    if boolean:
        return "true" if not lowercase else "True"
    return "false" if lowercase else "False"
